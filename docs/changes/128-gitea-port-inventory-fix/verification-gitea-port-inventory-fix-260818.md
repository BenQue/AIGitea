...
| AC-8 | PARTIAL | readable branch/docs/atomic commits 已 PASS；PR/protection/CI readback 尚未执行 |
...
| T05 | PARTIAL | local verification/review PASS；final docs commit、push、PR/protection/CI readback 待执行 |
