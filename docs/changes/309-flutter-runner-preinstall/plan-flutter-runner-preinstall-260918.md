...
| T04 | `01-基础设施-VM-Gitea-Runner.md`：新增 Flutter 小节 + §4.1 as-built 更正（AC-4） | T02 | pending |
...
- **T04**：`01-基础设施-VM-Gitea-Runner.md`（§4.1 重写 + 新增小节）。
...
| AC-4 | `git diff` review `01-基础设施-VM-Gitea-Runner.md`，逐条比对 §4.1 新文本与 T02 前的只读实测输出 |
