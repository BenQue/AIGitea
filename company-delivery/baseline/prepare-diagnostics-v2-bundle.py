#!/usr/bin/env python3
"""Development-side exact-commit diagnostics review bundle builder/verifier (#280)."""
...
COLLECTOR = "codex/runtime/aisoft_company_baseline_diagnostics_v2.py"
BUILDER = "company-delivery/baseline/prepare-diagnostics-v2-bundle.py"
SOURCE_FILES = {
    "aisoft_company_baseline_diagnostics_v2.py": COLLECTOR,
    "diagnostics-v2.schema.json": "company-delivery/baseline/diagnostics-v2.schema.json",
    "profile-v1.schema.json": "company-delivery/baseline/profile-v1.schema.json",
    "DIAGNOSTICS-V2.md": "company-delivery/baseline/DIAGNOSTICS-V2.md",
}
...
def materialize(repo, source, profile_path, expected_profile):
    ...
    if (module.decode(files["diagnostics-v2.schema.json"]) != module.schema()
    ...
    manifest = {"contract_version": "company-platform-baseline-diagnostics-review-bundle/v2",
