...
- Keep final PR merge as the only delivery gate. Interactive Issue sessions have exactly two default confirmation points: submit the unique final PR; and, after merge, terminal reconciliation, document checks, and cleanup complete, confirm archival. Never push directly to protected `main`.
